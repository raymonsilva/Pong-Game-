...
simulate_player(float *p, float *dp, float ddp, float dt) {
	...
	*dp = *dp + ddp * dt;
	...
	// Criação Da Colisão para o player 1
...
simulate_game(Input* input, float dt) {
	...
	// Simulação da bola
	{
		// Colisão da bola para o lado direito
		...
		} // Colisão da bola para o lado esquerdo
		...
		// Reseta a bola para o meio se ela sair da arena 
	...
	draw_rect(80, player_1_p, player_half_size_x, player_half_size_y, 0x0ff0000);
	draw_rect(-80, player_2_p, player_half_size_x, player_half_size_y, 0x0ff0000);
